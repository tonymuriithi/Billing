...
<span class="nav-link-text">Meter Category</span></a>
...
<i class="ion ion-ios-copy"></i>
<span class="nav-link-text">Customers</span></a>
<ul id="company_drp" class="nav flex-column collapse collapse-level-1">
<li class="nav-item">
<ul class="nav flex-column">
<li class="nav-item">
<a class="nav-link" href="add-company.php">Add Customer</a>
</li>
<li class="nav-item">
...
<span class="nav-link-text">Billing</span></a>
...
<span class="nav-link-text">Search Bill</span>
</a>
</li>
