...
<style type="text/css">
#wrapper{
	height:100%; width:100%; margin:0 auto; position:relative; border:3px solid rgba(0,0,0,0); -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; -webkit-box-shadow:0 0 18px rgba<br />
...
<?php
include 'db.php';
$result = mysqli_query($conn, "SELECT * FROM tblmeter where account = '2'");
