    ...
    <div id="home" class="tab-pane fade in active">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
              ...
              <form enctype="multipart/form-data" action="import.php" method="post"role="form">
...
<ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="bill.php">&nbsp;Account 3</a></li>
</ul></div>
<?php
include 'db.php';
$result = mysqli_query($conn, "SELECT * FROM tblmeter where account = '3' ORDER BY usernumber ASC ");
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<a rel='facebox' href='payments.php?id=".$row['id']."'><span class=\"btn btn-danger  btn-xs glyphicon glyphicon-eye-open\">Payments</span>|</a>";
 echo "</tr>";
  }
echo "</table>";
