...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `tblmeter` WHERE CONCAT(`id`, `username`, `usernumber`, `meternu`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `tblmeter`";
    $search_result = filterTable($query);
}
...
<div  style="overflow:scroll; height:350px;">
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
               ...
               <!-- <a href="deleteclient.php"><button class="btn btn-danger btn-xs">Delete all</button></a>-->
                <a href="generate.php" class="btn btn-primary btn-xs pull-right"><b>+</b>Genrate Excel</a> 
 ...
 <?php
include 'db.php';
$result = mysqli_query($conn, "SELECT * FROM tblmeter");
